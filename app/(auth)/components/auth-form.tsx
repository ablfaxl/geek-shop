...
import { Bitcoin, Eye, EyeOff, Lock, Mail, User, Wallet } from "lucide-react";
import { z } from "zod";
...
export default function AuthForm() {
  ...
  function onSignInSubmit(values: z.infer<typeof signInSchema>) {
    ...
    //   description: "Welcome back to CryptoVault!",
    // })
    // todo
    console.log(values);
  }
  ...
  function onSignUpSubmit(values: z.infer<typeof signUpSchema>) {
    ...
    //   description: "Welcome to CryptoVault! Your account has been created successfully.",
    // })
    console.log(values);
  }
        ...
        <Card className="border-gray-200 bg-white text-black shadow-xl shadow-black/5">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-gray-500">
              Enter your credentials to access your digital assets
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...signInForm}>
      ...
      >
        <Card className="border-gray-200 bg-white text-black shadow-xl shadow-black/5">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-gray-500">
              Enter your information to create your crypto wallet
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...signUpForm}>
